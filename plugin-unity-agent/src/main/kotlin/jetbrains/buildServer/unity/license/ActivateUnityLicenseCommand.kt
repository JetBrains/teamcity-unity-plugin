...
class ActivateUnityLicenseCommand(
    ...
    override fun processFinished(exitCode: Int) {
        ...
        buildLogger.logMessage(createBlockEnd(BUILD_LOG_BLOCK, BUILD_LOG_BLOCK_TYPE))
    }
    ...
    companion object {
        private val LOG = Logger.getInstance(ActivateUnityLicenseCommand::class.java.name)

        private const val BUILD_LOG_BLOCK = "Activate Unity license"
