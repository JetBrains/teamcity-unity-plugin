...
class UnityToolProvider(
    ...
    override fun getPath(
        ...
        ensureToolIsSupported(toolName)
        return getUnity(runner).unityPath
    }

    fun getUnity(runnerContext: BuildRunnerContext): UnityEnvironment {
    ...
    private fun discoverUnityByPath(runnerContext: BuildRunnerContext) =
